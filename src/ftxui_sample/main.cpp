...
// configuration step. It creates a namespace called `egakeru`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", egakeru::cmake::project_name, egakeru::cmake::project_version) };

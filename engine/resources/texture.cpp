...
namespace egkr
{
    ...
    void texture::create(const properties& texture_properties, const uint8_t* texture_data, texture* out_texture) { return renderer->create_texture(texture_properties, texture_data, out_texture); }

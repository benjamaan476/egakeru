...
namespace egkr
{
	...
	public:
	    ...
	    virtual bool begin(uint32_t frame_index) const = 0;
	    ...
	    void set_render_targets(const egkr::vector<render_target::render_target::shared_ptr>& targets) { render_targets_ = targets; }
	protected:

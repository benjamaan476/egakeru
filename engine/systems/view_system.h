...
namespace egkr
{
	...
	public:
		...
		static render_view_packet build_packet(render_view* view, void* data);
		static bool on_render(const render_view* view, const render_view_packet* packet, uint32_t frame_number, uint32_t render_target_index);

...
namespace egkr
{
    shader::shared_ptr vulkan_shader::create(const vulkan_context* context, const properties& shader_properties) { return std::make_shared<vulkan_shader>(context, shader_properties); }
    ...
    vulkan_shader::~vulkan_shader() { free(); }
